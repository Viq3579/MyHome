...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/coverpage.css') }}">
            ...
            <div class="cover">
                ...
                <div class="cover-info">
                    <p class="cover-description">
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ducimus iste inventore sequi! Esse, fugit corrupti!
                    </p>
                    
                    <a class="signup" href="signup">Sign Up Today</a>
                </div>
            </div>
