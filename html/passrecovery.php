...
<html>
    ...
    <head>
        ...
        <title>MyHome - Password Recovery</title>
        ...
        <main class="main-content" style="display: flex; flex-direction: column; align-items: center;">
            ...
            <div class="container">
                ...
                <div class="center-content">
                    ...
                    <form class="item important-item clear" action="passrecovery.php" method="post">

                        <h1 class="login-title">Change Your Password</h1>

                        <div class="input">
                            <label class="input-header" for="password">Password:</label>
                            <input class="input-field white" type="password" id="password" name="password">
                            <input type="hidden" name="email" value="<?php echo $email;?>">
                        </div>

                        <div class="input">
                            <label class="input-header" for="password_confirmation">Confirm Password:</label>
                            <input class="input-field white" type="password" id="password_confirmation" name="password_confirmation">
                        </div>
