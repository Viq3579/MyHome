...
<html>
    ...
    <head>
        ...
        <title>MyHome - Request Quote</title>
        ...
        <main class="main-content">
            ...
            <div class="container">
                ...
                <div class="center-content">
                    ...
                    <form class="item important-item clear" action="requestquote.php" method="post">

                        <h1 class="login-title">Request Quote</h1>

                        <div class="input">
                            <label class="input-header" for="provider">Provider Name:</label>
                            <input class="input-field white" type="text" id="pname" name="pname" required>
                        </div>

                        <div class="input">
                            <label class="input-header" for="service">Service Name:</label>
                            <input class="input-field white" type="text" id="sname" name="sname" required>
                        </div>

                        <div class="input">
                            <label class="input-header" for="customer">Your Name:</label>
                            <input class="input-field white" type="text" id="cname" name="cname" required>
                        </div>
