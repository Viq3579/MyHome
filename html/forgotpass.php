...
<html>
    ...
    <head>
        ...
        <title>MyHome - Forgot Password</title>
        ...
        <main class="main-content" style="display: flex; flex-direction: column; align-items: center;">
            ...
            <div class="container">
                ...
                <div class="center-content">
                    ...
                    <form class="item important-item clear" action="forgotpass.php" method="post">
                        ...
                        <div class="input">
                            ...
                            <input class="input-field white" type="email" id="email" name="email" required>
                        </div>
